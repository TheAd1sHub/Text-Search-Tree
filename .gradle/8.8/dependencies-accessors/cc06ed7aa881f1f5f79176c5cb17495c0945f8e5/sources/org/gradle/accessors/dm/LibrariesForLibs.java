...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    public static class OrgApacheLoggingLog4jLog4jLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {
        ...
        /**
         * Dependency provider for <b>log4j</b> with <b>org.apache.logging.log4j:log4j</b> coordinates and
         * with version reference <b>org.apache.logging.log4j.log4j</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> asProvider() {
            return create("org.apache.logging.log4j.log4j");
        }
    ...
    public static class OrgFlywaydbFlywayLibraryAccessors extends SubDependencyFactory {
        private final OrgFlywaydbFlywayMavenLibraryAccessors laccForOrgFlywaydbFlywayMavenLibraryAccessors = new OrgFlywaydbFlywayMavenLibraryAccessors(owner);

        public OrgFlywaydbFlywayLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Group of libraries at <b>org.flywaydb.flyway.maven</b>
         */
        public OrgFlywaydbFlywayMavenLibraryAccessors getMaven() {
            return laccForOrgFlywaydbFlywayMavenLibraryAccessors;
        }

    }

    public static class OrgFlywaydbFlywayMavenLibraryAccessors extends SubDependencyFactory {

        public OrgFlywaydbFlywayMavenLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>plugin</b> with <b>org.flywaydb:flyway-maven-plugin</b> coordinates and
         * with version reference <b>org.flywaydb.flyway.maven.plugin</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getPlugin() {
            return create("org.flywaydb.flyway.maven.plugin");
        }
    ...
    public static class OrgApacheLoggingLog4jLog4jVersionAccessors extends VersionFactory  implements VersionNotationSupplier {
        ...
        /**
         * Version alias <b>org.apache.logging.log4j.log4j</b> with value <b>2.23.1</b>
         * <p>
         ...
         */
        public Provider<String> asProvider() { return getVersion("org.apache.logging.log4j.log4j"); }
    ...
    public static class OrgApacheLoggingLog4jLog4jSlf4jVersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>org.apache.logging.log4j.log4j.slf4j.impl</b> with value <b>2.20.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
    ...
    public static class OrgFlywaydbFlywayVersionAccessors extends VersionFactory  {
        ...
        private final OrgFlywaydbFlywayMavenVersionAccessors vaccForOrgFlywaydbFlywayMavenVersionAccessors = new OrgFlywaydbFlywayMavenVersionAccessors(providers, config);
        public OrgFlywaydbFlywayVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

        /**
         * Group of versions at <b>versions.org.flywaydb.flyway.maven</b>
         */
        public OrgFlywaydbFlywayMavenVersionAccessors getMaven() {
            return vaccForOrgFlywaydbFlywayMavenVersionAccessors;
        }

    }

    public static class OrgFlywaydbFlywayMavenVersionAccessors extends VersionFactory  {

        public OrgFlywaydbFlywayMavenVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

        /**
         * Version alias <b>org.flywaydb.flyway.maven.plugin</b> with value <b>10.13.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getPlugin() { return getVersion("org.flywaydb.flyway.maven.plugin"); }
    ...
    public static class OrgSlf4jSlf4jVersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>org.slf4j.slf4j.nop</b> with value <b>2.0.7</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
    ...
    public static class OrgXerialSqliteVersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>org.xerial.sqlite.jdbc</b> with value <b>3.45.3.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
